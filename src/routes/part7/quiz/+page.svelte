...
<svelte:head>
	<title
		>{meta?.title ?? 'Quiz de synthèse — Partie VII'} — Fondations de l'Apprentissage Statistique</title
	>
</svelte:head>

<PageTemplate
	title={meta?.title ?? 'Quiz de synthèse — Partie VII'}
