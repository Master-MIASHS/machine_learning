<script lang="ts">
	...
	const meta = getPageByPath('/part10/lesson1');
	const tracker = createPageTracker(meta as PageMeta);

	const quiz = getQuizQuestions('p10/l1');
...
>
	<TheorySection>
		...
		<p>
			La Partie VII a caractérisé le classifieur de Bayes <KatexInline formula={'h^*'} /> : il minimise
