...
<PageTemplate
	...
	subtitle="Facteurs, codages, interactions et covariance"
	prev={prevMeta}
	next={nextMeta}
>
	<Callout type="note" title="Page en construction">
		La leçon « Le modèle linéaire général : ANOVA et ANCOVA » sera rédigée à partir de
		<code>course_sources/sophie/ModèleLinéaire_ANOVA_ANCOVA.pdf</code>.
	</Callout>
</PageTemplate>
