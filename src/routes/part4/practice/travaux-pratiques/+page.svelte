...
<svelte:head>
	<title>{meta?.title ?? 'Travaux pratiques'} — Fondations de l'Apprentissage Statistique</title>
</svelte:head>

<PageTemplate
	title={meta?.title ?? 'Travaux pratiques'}
	subtitle="Régression linéaire : estimation, diagnostic, inférence et sélection (R)"
	prev={prevMeta}
	next={nextMeta}
>
